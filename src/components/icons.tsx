/**
 * SVG icons extracted verbatim from https://niec.edu.np/.
 * Sources: Elementor's own icon set (`e-eicon-*`) and Font Awesome 5 (`e-fas-*` / `e-fab-*`),
 * both of which the site renders as inline SVG. Paths are unmodified.
 *
 * All icons inherit colour via `fill="currentColor"` and size via the className prop.
 */
...
export function MenuIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 1000 1000" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
...
export function PaperPlaneIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
...
export function FileTextIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 384 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
...
export function CrownIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 640 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
...
export function InstagramIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 448 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
...
export function YoutubeIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 576 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
...
export function CaretDownIcon(props: IconProps) {
  return (
    <svg viewBox="0 357 571.4 322" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
...
/** Font Awesome *regular* envelope. `EnvelopeIcon` above is the solid variant; the
 *  contact page uses this outlined one, so both are kept. */
export function EnvelopeOutlineIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
